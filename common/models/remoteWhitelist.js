/**
 * This disables all remotes for the given model except remotes in the white list
 *
 * @param model the model to disable remotes for
 * @param methodsToExpose the method white list
 */
module.exports = function (model, methodsToExpose) {
